...
genelist_input <- fread(file="ALL DEGs.txt", header = T, sep='\t', data.table = F)
...
gene_map
write.csv(as.data.frame(gene_map),"Gene Name Translation.csv",row.names =F)
...
ggsave(p1,filename ='GO_BP Bubble plot.pdf',width = 7.23,height = 8)
ggsave(p1,filename ='GO_BP Bubble plot.TIFF',width = 7.23,height = 8)
...
p1<-p1 + scale_y_discrete(labels=function(x) str_wrap(x, width=50))
ggsave(p1,filename ='GO_CC Bubble plot.pdf',width = 7.23,height = 8)
ggsave(p1,filename ='GO_CC Bubble plot.TIFF',width = 7.23,height = 8)
...
p1<-p1 + scale_y_discrete(labels=function(x) str_wrap(x, width=50))
ggsave(p1,filename ='GO_MF Bubble plot.pdf',width = 7.23,height = 8)
ggsave(p1,filename ='GO_MF Bubble plot.TIFF',width = 7.23,height = 8)
...
ggsave(p,filename ='GO Bubble plot.pdf',width = 7.23,height = 8)
ggsave(p,filename ='GO Bubble plot.TIFF',width = 7.23,height = 8)
...
p1<-p1 + scale_y_discrete(labels=function(x) str_wrap(x, width=50))
ggsave(p1,filename ='KEGG Bubble plot.pdf',width = 7.23,height = 8)
ggsave(p1,filename ='KEGG Bubble plot.TIFF',width = 7.23,height = 8)
...
p1<-p1 + scale_y_discrete(labels=function(x) str_wrap(x, width=50))
ggsave(filename ='KEGG Bubble plot2.pdf',width = 8,height = 8)
ggsave(filename ='KEGG Bubble plot2.TIFF',width = 8,height = 8)
...
ggbarplot(drawdata, x = "Description", y = 'yyy',
          fill = "ONTOLOGY",               
          color = "white",            
          palette = c('#5FB404','#01DFD7','#C238E5'),           
          sort.val = "desc",          
...
ggbarplot(drawdata, x = "Description", y = "yyy",
          fill = "ONTOLOGY",               
          color = "white",            
          palette = c('#5FB404','#12B5EC','#C238E5'),            
          sort.val = "asc",           
          sort.by.groups = TRUE,      
          x.text.angle = 75, 
          ylab = '-log10(P-Value)',
...
ggsave(filename ='GO CC MF BP2.pdf',width = 7.23,height = 8)
ggsave(filename ='GO CC MF BP2.TIFF',width = 7.23,height = 8)
